...
from transfermarktApi.main.services.base import TransfermarktBase
from transfermarktApi.main.utils.regex import REGEX_BG_COLOR, REGEX_COUNTRY_ID, REGEX_MEMBERS_DATE
from transfermarktApi.main.utils.utils import extract_from_url, remove_str, safe_regex, safe_split
from transfermarktApi.main.utils.xpath import Clubs
